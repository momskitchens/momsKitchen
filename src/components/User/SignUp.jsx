...
function SignUp() {
    ...
    return (
        <>
            ...
            {/* Form Section */}
            <div className='order-2 sm:order-1 flex flex-col items-center sm:w-2/5 w-full bg-white rounded-t-2xl sm:rounded-none  shadow-lg sm:shadow-none -mt-10 sm:mt-0'>
                <div className='flex flex-row items-center xl:items-start mt-20'>
                    ...
                    <form className='mt-5 w-96' onSubmit={handleSubmit(userSignupHandle)}>
                        ...
                        <div className='m-5 sm:mx-10'>
                            <Input
                                ...
                                {...register("password", { required: true, pattern: /^[a-zA-Z0-9!@#$%^&*_]{8,}$/ })}
                            />
                            {errors.password?.type === 'required' && <p role='alert' className='text-sm font-semibold text-red-800'>*Password is required</p>}
                            {errors.password?.type === 'pattern' && <p role='alert' className='text-sm font-semibold text-red-800'>*Enter a valid Password more than length 8</p>}
                        </div>
